...
export const NAVIGATION = [
  ...
  { name: "Solusi Industri", href: "solutions" },
...
export const PILLARS = [
  {
    ...
    description: "Sistem deteksi dan pemadam api standar global untuk melindungi nyawa dan aset berharga.",
    icon: "Flame",
    color: "bg-orange-600",
  },
  {
    title: "Security Systems",
    description: "Ekosistem keamanan fisik terpadu melalui CCTV cerdas dan kontrol akses pintu.",
    icon: "ShieldCheck",
    color: "bg-blue-600",
  },
  {
    title: "Infrastructure & Data",
    description: "Jaringan data kecepatan tinggi dan sistem komunikasi untuk efisiensi operasional.",
    icon: "Network",
    color: "bg-slate-700",
  },
];
...
export const INDUSTRIES = [
  { name: "Perkantoran", description: "Keamanan akses dan proteksi kebakaran gedung bertingkat." },
  { name: "Pabrik & Gudang", description: "Sistem hidran kapasitas besar dan pengawasan perimeter." },
  { name: "Institusi Medis", description: "Nurse call system dan sistem komunikasi darurat." },
  { name: "Apartemen", description: "Integrasi sistem keamanan dan fire alarm untuk hunian." },
  { name: "Galangan Kapal", description: "Peralatan tahan korosi untuk lingkungan maritim." },
];

export const CONTACT_INFO = {
  address: "Latinos Business District, Tangerang Selatan, Banten, Indonesia",
  phone: "+62 812-xxxx-xxxx",
  email: "info@tosafeng.com",
  maps_link: "https://maps.google.com/?q=Latinos+Business+District+Tangsel",
};
